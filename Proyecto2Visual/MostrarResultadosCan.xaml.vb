...
Imports Proyecto2Visual.MainWindow

Public Class MostrarResultadosCan
    ...
    Private Sub Window_Loaded(sender As Object, e As RoutedEventArgs)
        Using conexion As New OleDbConnection(strConexion)
            ...
            dataGridVotosPrefectos.DataContext = dsVotos3
            dataGridVotosAsambleistas.DataContext = dsVotos2

            Dim numbar1 As Integer = -285

            If (Variable = "1") Then
                label1.Visibility = True
                label2.Visibility = True
                dataGridMosAsambleistas.Visibility = True
                dataGridMosPrefectos.Visibility = True
                dataGridVotosPrefectos.Visibility = True
                dataGridVotosAsambleistas.Visibility = True
                ...
                For Each VotoPresidente As DataRow In dsVotos.Tables("tblCandidato").Rows
                    ...
                    barra.Margin = New Thickness(200, numbar1, 0, 0)
                    ...
                    lbl.Margin = New Thickness(200, numbar1, 0, 0)
            ...
            If (Variable = "2") Then
                ...
                label1.Visibility = True
                dataGridMosPresidentes.Visibility = True
                dataGridVotosPresidentes.Visibility = True
                dataGridMosPrefectos.Visibility = True
                dataGridVotosPrefectos.Visibility = True
